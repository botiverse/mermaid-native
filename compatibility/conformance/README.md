# Official Mermaid conformance corpus
...
The current corpus is an incremental port, not the complete upstream Mermaid
suite. Each batch expands coverage from the pinned revision without claiming
that unported upstream tests are supported.
